package com.starmaid.Cibele.states {
    ...
    public class StartScreen extends GameState {
        ...
        override public function create():void {
            ...
            startText3 = new FlxText(ScreenManager.getInstance().screenWidth * .22, this.crystalIcon.y + (this.crystalIcon.height + 75),1000,"This build contains the first of three acts. Please note that it is, however, still in development.\nPlease do not share this build with anyone.");
            add(startText3);
