package com.starmaid.Cibele.states {
    ...
    public class HiisiDesktop extends Desktop {
        ...
        [Embed(source="/../assets/images/ui/popups/hi_files/chatlog_aug.png")] private var ImgChatlogFolder:Class;
        ...
        override public function create():void {
            this.bgImageName = "UI_Desktop_Hi";
            super.create();
            ScreenManager.getInstance().setupCamera(null, 1);
            var _screen:ScreenManager = ScreenManager.getInstance();

            PopUpManager.getInstance().setOpeningPopups(PopUpManager.HI_EMAIL_ICHI, PopUpManager.HI_SELFIE_DC, PopUpManager.HI_PICLY_DEF);
